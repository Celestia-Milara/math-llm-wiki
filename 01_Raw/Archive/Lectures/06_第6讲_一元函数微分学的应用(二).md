...
wiki_link: [[介值定理-IntermediateValueTheorem]], [[费马定理-FermatTheorem]], [[罗尔定理-RolleTheorem]], [[拉格朗日中值定理-LagrangeMVT]], [[柯西中值定理-CauchyMVT]], [[泰勒公式-TaylorFormula]], [[辅助函数构造法-AuxiliaryFunction]], [[微分不等式证明-DifferentialInequality]], [[方程根的讨论-RootExistence]]
---
...
![](06_第6讲_一元函数微分学的应用(二)_002.jpg)

# 基础知识结构

![](06_第6讲_一元函数微分学的应用(二)_003.jpg)

![](06_第6讲_一元函数微分学的应用(二)_004.jpg)

![](06_第6讲_一元函数微分学的应用(二)_005.jpg)

# 基础内容精讲

![](06_第6讲_一元函数微分学的应用(二)_006.jpg)

# 中值定理

![](06_第6讲_一元函数微分学的应用(二)_007.jpg)

![](06_第6讲_一元函数微分学的应用(二)_008.jpg)

# 涉及函数的中值定理

设 $f(x)$ 在 $[a,b]$ 上连续，则

![](06_第6讲_一元函数微分学的应用(二)_009.jpg)
...
$$
m \leqslant f \left(x _ {n}\right) \leqslant M,
$$
...
设 $f\left( x\right)$ 满足 $\left\{  \begin{array}{l} 1 \in  \left\lbrack  {a,b}\right\rbrack  \text{上连续，} \\  2 \in  \left( {a,b}\right) \text{内可导，则存在} \end{array}\right.$ 在 $\xi  \in  \left( {a,b}\right)$ ,使得 ${f}^{\prime }\left( \xi \right)  = 0$ .

![](06_第6讲_一元函数微分学的应用(二)_015.jpg)  
罗尔

(1652-1719)

![](06_第6讲_一元函数微分学的应用(二)_016.jpg)
...
![](06_第6讲_一元函数微分学的应用(二)_018.jpg)

![](06_第6讲_一元函数微分学的应用(二)_019.jpg)  
拉格朗日
...
![](06_第6讲_一元函数微分学的应用(二)_021.jpg)

# 微分等式

![](06_第6讲_一元函数微分学的应用(二)_022.jpg)
...
![](06_第6讲_一元函数微分学的应用(二)_023.jpg)

若 $f(x)$ 在 $[a,b]$ 上连续，且 $f(a)f(b) < 0$ ，则 $f(x) = 0$ 在 $(a,b)$ 内至少有一个根.

2 单调性（证明根的唯一性）

![](06_第6讲_一元函数微分学的应用(二)_024.jpg)
...
由 $f^{\prime}(x) = 2^{x}\bullet \ln 2 - 2x$ ， $f''(x) = 2^{x}\bullet \ln^{2}2 - 2$ ， $f^{\prime \prime}(x) = 2^{x}\bullet \ln^{3}2\neq 0$ ，知 $f(x) = 0$ 至多有三个根，即 $f(x) = 0$ 有且仅有三个根.单调性不好判断就继续求导 $f^{\prime \prime}(x) = 0$ 至多0个根个数 $f(x) = 0$ 至多 $0 + 3 = 3$ 个根
...
当 $x_0$ 为极大值点时，即为 $I$ 内的最大值点，有 $\overline{f(x) \leqslant M}$ ★(3)设 $f(x)$ 在 $I$ 内连续，且有唯一的极值点 $x_0$ ，则 $\begin{cases} \text{当} x_0 \text{为极大值点时，即为} I \text{内的最小值点，有} \\ f(x_0) \leqslant f(x), \end{cases}$ 当 $x_0$ 为极小值点时，即为 $I$ 内的最小值点，有
