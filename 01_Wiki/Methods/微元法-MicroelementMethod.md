---
title: 微元法
tags: [数学, 第10讲, 第11讲, 第12讲, 方法]
created: 2026-05-03
type: permanent
status: raw_compilation
summary: 用定积分解决几何、物理等应用问题的核心方法——取微元再积分。
source: 00_Raw/10_第10讲_一元函数积分学的应用(一).md
---
...
**来源**：`00_Raw/10_第10讲_一元函数积分学的应用(一).md`, `00_Raw/12_第12讲_一元函数积分学的应用(三).md`
...
TABLE
  ...
  summary as "摘要"
FROM "01_Wiki"
WHERE contains(tags, this.file.tags[1]) OR contains(tags, this.file.tags[1])
SORT file.name ASC
```
