...
summary: 双曲函数（双曲正弦、双曲余弦、双曲正切）的定义、基本恒等式、倍角公式、反双曲函数及其与对数函数的联系。
source: 00_Raw/23_附录5_从指数函数到双曲函数.md
---
...
> 本页内容由 AI 从 `00_Raw/23_附录5_从指数函数到双曲函数.md` 编译而成，尚未经人工审核。
...
FROM "01_Wiki"
WHERE contains(tags, "双曲函数") OR contains(tags, "指数函数")
SORT file.name ASC
```
