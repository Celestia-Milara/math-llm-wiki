...
wiki_link: "[[函数-Function]]、[[函数的极限-Limit]]、[[连续与间断-ContinuityAndDiscontinuity]]、[[极限计算方法-LimitCalculationMethods]]"
---
...
![](images/images/01_第1讲_函数极限与连续_002.jpg)

# 基础知识结构

![](images/01_第1讲_函数极限与连续_003.jpg)

![](images/01_第1讲_函数极限与连续_004.jpg)

注 以上是第1讲的全面的知识结构。学完这一讲，做完这一讲的题目之后，回过头来看这个知识结构，相信大家会有完全不同的认识。学完之后，这些知识框架不再是陌生的文字，而是展现在头脑中的清晰的知识与方法。

# 函数的概念与特性

![](images/01_第1讲_函数极限与连续_005.jpg)
...
![](images/01_第1讲_函数极限与连续_006.jpg)

![](images/01_第1讲_函数极限与连续_007.jpg)

图1-1  
![](images/01_第1讲_函数极限与连续_008.jpg)  
多值函数（不是我们传统意义上的函数）
...
设函数 $y = f(x)$ 的定义域为 $D$ ，值域为 $R$ 。如果对于每一个 $y \in R$ ，必存在唯一的 $x \in D$ ，使得 $y = f(x)$ 一手+V: kaoyan33311 成立，则由此定义了一个新的函数 $x = \varphi(y)$ ，这个函数称为函数 $y = f(x)$ 的反函数，一般记作 $x = f^{-1}(y)$ ，它的定义域为 $R$ ，值域为 $D$ 。相对于反函数来说，原来的函数也称为直接函数。以下两点需要说明。
...
![](images/01_第1讲_函数极限与连续_011.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_012.jpg)  
(b)   
图1-3
...
设函数 $y = f(u)$ 的定义域为 $D_{1}$ ，函数 $u = g(x)$ 在 $D$ 上有定义，且 $g(D)\subset D_1$ ，则由
...
![](images/01_第1讲_函数极限与连续_017.jpg)

![](images/01_第1讲_函数极限与连续_018.jpg)  
图1-5
...
![](images/01_第1讲_函数极限与连续_021.jpg)  
(A)

![](images/01_第1讲_函数极限与连续_022.jpg)

保留 $x \geqslant 0$ 部分, $x < 0$ 部分消去, 关于 $y$ 轴对称

![](images/01_第1讲_函数极限与连续_023.jpg)  
(B)

![](images/01_第1讲_函数极限与连续_024.jpg)

![](images/01_第1讲_函数极限与连续_025.jpg)  
两者关于 $y$ 轴对称  
(C)   
两者关于 $x$ 轴对称

![](images/01_第1讲_函数极限与连续_026.jpg)

![](images/01_第1讲_函数极限与连续_027.jpg)

![](images/01_第1讲_函数极限与连续_028.jpg)  
(D)   
关于原点对称

![](images/01_第1讲_函数极限与连续_029.jpg)
...
![](images/01_第1讲_函数极限与连续_030.jpg)

⑥ $f(x)$ 奇 $\Rightarrow \int_{0}^{x} f(t) \, \mathrm{d}t$ 偶. 微积分的研究主体：导数，积令（偶） （奇）

![](images/01_第1讲_函数极限与连续_031.jpg)
...
$$
\cos^ {2} x = \frac {1 + \cos 2 x}{2}. \text {则} T = \frac {2 \pi}{| 2 |} = \pi .
$$

★③若 $f(x)$ 是以 $T$ 为周期的可导函数，则 $f^{\prime}(x)$ 也以 $T$ 为周期.见例3.1.  
...
![](images/01_第1讲_函数极限与连续_032.jpg)

1 基本初等函数与初等函数 我们在学习含部积分法时，有口诀：反对幂指三.

基本初等函数：常数函数、幂函数、指数函数、对数函数、三角函数和反三角函数.

(1) 常数函数. 易考“找交点个数”或在概率论中求概率 $P\{g(X) \leqslant y\}$ .

$y = A$ ， $A$ 为常数，其图形为平行于 $x$ 轴的水平直线（见图1-6).为偶函数

![](images/01_第1讲_函数极限与连续_033.jpg)  
图1-6
...
![](images/01_第1讲_函数极限与连续_034.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_035.jpg)  
(b)

![](images/01_第1讲_函数极限与连续_036.jpg)  
(c)   
图1-7
...
考得频率不高 $\ln \left(x ^{\frac {1}{3}} y ^{\frac {1}{2}} z ^{\frac {1}{5}}\right) = \frac {1}{3}\ln x + \frac {1}{2}\ln y + \frac {1}{5}\ln z$
...
![](images/01_第1讲_函数极限与连续_037.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_038.jpg)  
(b)

![](images/01_第1讲_函数极限与连续_039.jpg)
...
![](images/01_第1讲_函数极限与连续_040.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_041.jpg)  
(b)   
图1-9
...
![](images/01_第1讲_函数极限与连续_042.jpg)

① 正弦函数与余弦函数.

正弦函数 $y = \sin x$ [见图1-10(a)], 余弦函数 $y = \cos x$ [见图1-10(b)].

![](images/01_第1讲_函数极限与连续_043.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_044.jpg)  
(b)

![](images/01_第1讲_函数极限与连续_045.jpg)  
图1-10
...
![](images/01_第1讲_函数极限与连续_047.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_048.jpg)  
(b)   
图1-11
...
![](images/01_第1讲_函数极限与连续_049.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_050.jpg)  
(b)   
图1-12
...
![](images/01_第1讲_函数极限与连续_051.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_052.jpg)  
(b)   
图1-13
...
![](images/01_第1讲_函数极限与连续_056.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_057.jpg)  
(b)   
图1-16
...
![](images/01_第1讲_函数极限与连续_058.jpg)  
图1-17

# 2 分段函数 有别于初等函数的另一种重要的函数.

在自变量的不同变化范围中，对应法则用不同式子来表示的函数称为分段函数.需要强调一句，分段一手+V：kaoyan33311函数是用几个式子来表示的一个（不是几个）函数.一般来说，它不是初等函数.分段函数的典型形式如下：
...
$\left| x\right|$ 既然是分段函数,那它是不是初等函数呢？是,因为 $\left| x\right|  = \sqrt{{x}^{2}}$ .一般来讲,今段函数不是初等函数,但 $\left| x\right|$ 是一个特例.
...
![](images/01_第1讲_函数极限与连续_059.jpg)  
(a)

![](images/01_第1讲_函数极限与连续_060.jpg)  
(b)   
图1-18
...
![](images/01_第1讲_函数极限与连续_061.jpg)  
图1-19

注 $\star \star \star$ (1) $[x + n] = [x] + n$ ，其中 $n$ 为整数.

$\star$ (2) $x - 1 <   [x]\leqslant x$   
...
![](images/01_第1讲_函数极限与连续_063.jpg)  
图1-21

(3) $y = \arcsin (\sin x)$ ，其图形如图1-22所示.

![](images/01_第1讲_函数极限与连续_064.jpg)  
图1-22
...
![](images/01_第1讲_函数极限与连续_065.jpg)

我们首先要厘清极限的概念，概念懂了，后面的性质是显然的，计算就会遵循概念和性质，从而不会出错.

# 邻域

![](images/01_第1讲_函数极限与连续_066.jpg)
...
![](images/images/01_第1讲_函数极限与连续_067.jpg)

$②$ 去心 $\delta$ 邻域.定义点 $x_0$ 的去心邻域 $\bar{U} (x_0,\delta) = \left\{x\mid 0 <   |x - x_0| <   \delta \right\} .$ $③$ 左、右 $\delta$ 邻域． $\{x|0 <   x - x_0 <   \delta \}$ 称为点 $x_0$ 的右 $\delta$ 邻域，记作 $U^{+}(x_{0},\delta)$ ； $\{x|0 <   x_0 - x <   \delta \}$ 称为点 $x_0$ 的左 $\delta$ 邻域，记作 $U^{-}(x_0,\delta)$ ：
...
![](images/01_第1讲_函数极限与连续_068.jpg)  
图1-23

任给 $\varepsilon_1 > 0$ ，再给 $\varepsilon_2 > 0$ ，…，再给 $\varepsilon_{n} > 0$ ，当 $\varepsilon$ 一直取下去，越来越小，两条线越来越近.不管有多近，总能找到一个小邻域，使得在该邻域内，除了 $x_0$ 之外，曲线被夹在宽度要多小有多小的这两条线中，则称 $x\to x_0$ ， $f(x)\rightarrow A$ .这就是魏尔斯特拉斯给的极限的标准语言.

![](images/01_第1讲_函数极限与连续_069.jpg)

函数极限一共有24个定义，其中自变量趋近方式有6种，函数趋近方式有4种，如表所示.

# 显微镜

<table><tr><td></td><td>f(x)→A</td><td>f(x)→∞</td><td>f(x)→+∞</td><td>f(x)→-∞</td></tr><tr><td rowspan="2">x→x0</td><td rowspan="2">∀ε&gt;0, ∃δ&gt;0,使得当0&lt;|x-x0|&lt;δ时,有|f(x)-A|&lt;ε</td><td rowspan="2">∀M&gt;0, ∃δ&gt;0,使得当0&lt;|x-x0|&lt;δ时,有|f(x)|&gt;M</td><td>∀M&gt;0, ∃δ&gt;0,使得当0&lt;|x-x0|&lt;δ时,有f(x)&lt;-M</td><td>∀M&gt;0, ∃δ&gt;0,使得当0&lt;|x-x0|&lt;δ时,有f(x)&lt;-M</td></tr><tr><td>时,有f(x)&gt;M</td><td>无限靠近“-∞”</td></tr><tr><td>x→x0+(右极限)</td><td>∀ε&gt;0, ∃δ&gt;0,使得当0&lt;x-x0&lt;δ时,有|f(x)-A|&lt;ε</td><td>∀M&gt;0, ∃δ&gt;0,使得当0&lt;x-x0&lt;δ时,有|f(x)|&gt;M</td><td>∀M&gt;0, ∃δ&gt;0,使得当0&lt;x-x0&lt;δ时,有f(x)&gt;M</td><td>∀M&gt;0, ∃δ&gt;0,使得当0&lt;x-x0&lt;δ时,有f(x)&lt;-M</td></tr><tr><td>x→x0-(左极限)</td><td>∀ε&gt;0, ∃δ&gt;0,使得当0&lt;x-x&lt;δ时,有|f(x)-A|&lt;ε</td><td>∀M&gt;0, ∃δ&gt;0,使得当0&lt;x-x&lt;δ时,有|f(x)|&gt;M</td><td>∀M&gt;0, ∃δ&gt;0,使得当0&lt;x-x&lt;δ时,有f(x)&gt;M</td><td>∀M&gt;0, ∃δ&gt;0,使得当0&lt;x-x&lt;δ时,有f(x)&lt;-M</td></tr></table>

![](images/01_第1讲_函数极限与连续_070.jpg)  
...
如 $\lim_{x\to 0}(x - x) = \lim_{x\to 0}0 = 0$ 实数运算 趋根运算 $=$ 段值0
...
如 $\lim_{x\to 0}\left(\frac{\sin x}{x} +\sin \frac{1}{x}\right)$ ，其中 $\lim_{x\to 0}\frac{\sin x}{x} = 1,\lim_{x\to 0}\frac{1}{x}$ 不存在（在-1到1之间振荡），则 $\lim_{x\to 0}\left(\frac{\sin x}{x} +\sin \frac{1}{x}\right) =$ $1+$ 不存在 $=$ 不存在.
...
b. $\lim_{x\to x_0}\frac{f(x)g(x)}{1} = \frac{\text{不存在或} \infty}{2}$ （不存在或）
...
$$
\mathrm {c .} \lim  _ {x \rightarrow x _ {0}} \frac {f (x)}{g (x)} = \lim  _ {x \rightarrow x _ {0}} f (x) \cdot \frac {1}{g (x)}.
$$
...
![](images/01_第1讲_函数极限与连续_077.jpg)

注 (1) 函数极限存在的充要条件.

![](images/01_第1讲_函数极限与连续_078.jpg)

![](images/01_第1讲_函数极限与连续_079.jpg)  
一个超实数 $=$ 实数 $+$ 超实数
...
如果当 $x\to x_0$ （或 $x\rightarrow \infty$ ）时，函数 $f(x)$ 的极限为零，那么称函数 $f(x)$ 为当 $x\to x_0$ （或 $x\rightarrow \infty$ ）时的无穷小，记为 有两种，包括 本身就是0→是一个常数，唯一一个常数的无穷小（0是最高阶的无穷小），本身不是0，是趋于0的 $f(x)$ 或 $\{x_{n}\} \rightarrow$ 是一个极限过程
...
① $\lim  f(x) = \operatorname{std}\left[f(x)\right] \stackrel{\rightarrow}{\text{实数部分（最终归属）}}$   
当 $x\to 0$ 时， $\sin x = \frac{\operatorname{std}(\sin x)}{0} +\frac{\sin x - \operatorname{std}(\sin x)}{\text{无穷小量}}.$   
② $\lim_{x\to 0}f(x) = 0$

如：

![](images/01_第1讲_函数极限与连续_085.jpg)
...
![](images/01_第1讲_函数极限与连续_089.jpg)

# 无穷小的比阶

在讲极限概念时，柯西也好，魏尔斯特拉斯也好，比牛顿和莱布尼茨的进步只是用了一个不等式，可是他们也没有讲 $\alpha$ 到0的距离到底有多少， $\beta$ 到0的距离是多少？不过我们可以尝试从 $\alpha$ ， $\beta$ 的阶数比入手.

![](images/01_第1讲_函数极限与连续_090.jpg)

设在自变量的同一变化过程中， $\lim_{x\to 0}\alpha (x) = 0,\lim_{x\to 0}\beta (x) = 0$ ，且 $\beta (x)\neq 0$ ，则  
0 0 0若 $\lim_{\substack{\alpha (x)\\ \beta (x)}} = 0$ ，则称 $\alpha (x)$ 是比 $\beta (x)$ 高阶的无穷小，记为 $\alpha (x) = o\bigl (\beta (x)\bigr)$ 实数趋实数  
$\alpha (x)\to 0$ 的速度比 $\beta (x)\rightarrow 0$ 的速度快  
...
“等价”不是相等，如 $\lim_{x\to 0}\frac{\sin x}{x} = 1\neq 0$ ，而 $\lim_{x\to 0}\frac{x - \sqrt{\sin x}}{x^3} = \frac{1}{6}$
...
$\mathop{\lim }\limits_{{x \rightarrow  0}}\frac{x\sin \frac{1}{x}}{{x}^{2}} = \mathop{\lim }\limits_{{x \rightarrow  0}}\frac{1}{x}\overset{\text{ 极限不存在, 一会儿跑到无穷大, 一会 }}{ \downarrow  }$ 跑到0.所以这种不专一的趋实数定义为无界变量

![](images/01_第1讲_函数极限与连续_091.jpg)
...
![](images/01_第1讲_函数极限与连续_092.jpg)  
图1-26

注 使用时一般都要做广义化：可将 $x$ 替换为趋向于0的函数，请灵活使用.
...
![](images/01_第1讲_函数极限与连续_093.jpg)

# 无穷大的定义

如果当 $x \to x_0$ （或 $x \to \infty$ ）时，函数 $|f(x)|$ 无限增大，那么称函数 $f(x)$ 为当 $x \to x_0$ （或 $x \to \infty$ ）时的
...
$$
\lim  _ {x \to x _ {0}} f (x) = \infty \left(\text {或} \lim  _ {x \to \infty} f (x) = \infty\right).
$$

趋实数

![](images/01_第1讲_函数极限与连续_094.jpg)
...
$② \lim [f(x)\bullet g(x)] = \lim f(x)\bullet \lim g(x) = A\bullet B$ .特别地，若 $\lim f(x)$ 存在， $n$ 为正整数，则
...
![](images/01_第1讲_函数极限与连续_099.jpg)

以上结论非常重要，以后在有关定参数的题目中可直接使用，如下例.

![](images/01_第1讲_函数极限与连续_100.jpg)
...
1694年，约翰·伯努利要结婚，洛必达送给他一个大礼包，他说“你结婚去吧，给你一笔钱，不用还，给我一篇论文就可以了”，然后伯努利欣然接受，主动拿着论文找到洛必达，一手交钱，一手交论文，一手+V：kaoyan33311这篇文章就被无情的卖掉了，是什么文章呢？就是大家看到的“洛必达法则”。这个法则实际上是伯努利在1694年卖给了洛必达，这是历史上的真事。有个人还在里面瞎掺和，那个人叫莱布尼茨（1646—1716），莱布尼茨是伯努利的老师，伯努利真正的学生是欧拉，这里面混进了洛必达。莱布尼茨听伯努利说“洛必达很有钱”，就主动找到洛必达，“孩子，我还有论文呢，你要不要？”而洛必达来者不拒，“来来来，买”。所以几乎在同一时间，洛必达还在世界上发表了一篇论文，叫“行列式的概念”。行列式的概念是谁给的呢？“莱布尼茨”；谁发表的呢？“洛必达”；世界上第一本微积分教材推出的呢？“洛必达”。洛必达可以称之为“伟大的”数学知识的传播者，他把数学大家的创作汇总起来出成书了。
...
当x→0时，eainx-tanx 71 当x-tanx

a. 提出极限不为 0 的因式；b. 等价无穷小代换；c. 恒等变形（基本的恒等变形法如提公因式、拆项、

合并、分子分母同除变量的最高次幂等,高级的恒等变形法如变量代换,也叫换元法等).需要强调的是, 很多问题如果不化简就计算,可能计算会很复杂,甚至可能计算不出结果. 如负代换,倒代换
...
用在函数中，难度就很高了，对于这种问题呢，《考研

数学基础30讲》里面也会提及，我会给大家一个完整的
...
![](images/01_第1讲_函数极限与连续_105.jpg)  
(a)

![](images/images/01_第1讲_函数极限与连续_106.jpg)  
(b)
...
![](images/01_第1讲_函数极限与连续_112.jpg)  
图1-27

![](images/images/01_第1讲_函数极限与连续_113.jpg)  
图1-28

![](images/01_第1讲_函数极限与连续_114.jpg)
...
③（反函数的连续性）设 $y = f(x)$ 在区间 $I_{x}$ 上单调且连续，则反函数 $x = \varphi(y)$ 在对应的区间 $I_{y} = \{y | y = f(x), x \in I_{x}\}$ 上连续且有相同的单调性.

★ (3) 设 $f(x)$ 在点 $x = x_0$ 处连续，且 $f(x_0) > 0$ （或 $f(x_0) < 0$ ），则存在 $\delta > 0$ ，使得当 $|x - x_0| < \delta$ 时， $f(x) > 0$ （或 $f(x) < 0$ ）。这句话非常重要！

![](images/01_第1讲_函数极限与连续_115.jpg)
...
第一类间断点在考研中是要求考生区分的.第一类间断点只有可去间断点和跃跃间断点

![](images/01_第1讲_函数极限与连续_118.jpg)
...
![](images/01_第1讲_函数极限与连续_119.jpg)

![](images/01_第1讲_函数极限与连续_120.jpg)
...
![](images/01_第1讲_函数极限与连续_121.jpg)

无穷间断点和振荡间断点都属于第二类间断点. (第二类还有其他, 但与考研无关)

$\lim_{x \to x_0^+} f(x)$ ; 研究对象 $\lim_{x \to x_0^-} f(x)$ ; $f(x_0)$ .

$①$ 可去间断点； $②$ 跳跃间断点； $③$ 第二类间断点； $④ f ( x _ { 0 } ) \triangleq \operatorname * { l i m } _ { x \to x _ { 0 } } f ( x ) ~ .$
...
注 $\lim_{x\to \infty}\left(1 + \frac{a}{x}\right)^{\frac{bx + d}{x}} = \mathrm{e}^{ab}$ 是常用的公式.
...
$$
\begin{array}{l} \lim  _ {x \rightarrow 0} \left(\frac {a _ {1} ^ {x} + a _ {2} ^ {x} + \cdots + a _ {n} ^ {x}}{n}\right) ^ {\frac {n}{x}} = \exp \left\{\lim  _ {x \rightarrow 0} \frac {n}{x} \left(\frac {a _ {1} ^ {x} + a _ {2} ^ {x} + \cdots + a _ {n} ^ {x}}{n} - 1\right)\right\} \\ = \exp \left\{\lim  _ {x \rightarrow 0} \frac {a _ {1} ^ {x} - 1}{x} + \lim  _ {x \rightarrow 0} \frac {a _ {2} ^ {x} - 1}{x} + \dots + \lim  _ {x \rightarrow 0} \frac {a _ {n} ^ {x} - 1}{x} \right\} \\ = \exp \left\{\lim  _ {x \rightarrow 0} \left(a _ {1} ^ {x} \ln a _ {1} + a _ {2} ^ {x} \ln a _ {2} + \dots + a _ {n} ^ {x} \ln a _ {n}\right)\right\} = a _ {1} a _ {2} \dots a _ {n}. \\ \end{array}
$$
